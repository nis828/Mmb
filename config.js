...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "144.24.103.172", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 30067,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "oioio5655chendaprovcbhh", 
            ...
            bot: {
                ...
                ownerIds: ["1188036843573354556"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x00AE86,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/mJYHu9VEME",    // 👈 Your support server link
